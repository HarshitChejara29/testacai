...
const SixthSection = () => {
    return(
        <section className="w-full h-screen bg-[#33649D]">
            <div className="flex flex-col items-start justify-start pt-[18rem] px-[1.2rem] text-[#ffffff]">
                ...
                <button className="text-[1rem] tracking-[-0.06em] py-1 border-b border-[#ffffff]">START IMPORT</button>
            </div>
